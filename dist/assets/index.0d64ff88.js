...
const db = wh(app);
const savePost = (idUser2, post, date, likes) => {
  uf(sh(db, "posts"), {
    idUser: idUser2,
    post,
    date,
...
const onGetPosts = (callback) => cf(dl(sh(db, "posts"), Il("date", "desc")), callback);
const deletePost = (id2) => of(rh(db, "posts", id2));
const getPost = (id2) => Jl(rh(db, "posts", id2));
const editPost = (id2, newPost) => rf(rh(db, "posts", id2), newPost);
const likePost = (id2, idUser2) => rf(rh(db, "posts", id2), {
  likes: Sf(idUser2)
});
const dislikePost = (id2, idUser2) => rf(rh(db, "posts", id2), {
  likes: Df(idUser2)
});
const verifyUser = () => {
...
const buttonLoginG = (button, navigateTo2) => {
...
const cat = "/assets/github.55b2840e.png";
const Footer = () => {
  const viewFooter = `
    ...
    & <img src="${cat}" alt="Logo de Github"/>
    <a href="https://github.com/IndiraPe" target="_blank">Indira P\xE9rez </a>  \xA9Derechos Reservados
    `;
  return viewFooter;
};
const logoAlien = "/assets/404logo.f69a3826.png";
const AlienLuna = "/assets/imgLuna.e6dcca15.png";
const Error404 = () => {
  const viewError = `
  <article id= "boxCointaing404">
    <img id="alien" src= "${logoAlien}" alt="Imagen del Alien "/>
    <h1 id= "pageNotFoundText">P\xE1gina no encontrada</h1>
  ...
  footer2.innerHTML = Footer();
  return mainError;
};
const logo = "/assets/vaca1_480.df903d0e.png";
const Home = (navigateTo2) => {
  const viewHome = `
    <h1 id="tittleLogo">Frikis del Espacio</h1>
    <img id="logo" src='${logo}' alt="Imagen del logo "/>  
    <div id="btns">
      <button id="btn-login">Iniciar Sesi\xF3n</button>
...
const buttonRegister = (passwordValue, emailValue) => new Promise((resolve, reject) => {
...
const google$1 = "/assets/G.6dc50424.png";
const Register = (navigateTo2) => {
  ...
  <img id="logo-2" src="${logo}" alt="Imagen del logo"/>  
    <div class="register">
      ...
      <div class="container-register">
        <button class="btnG"><img src="${google$1}" alt="\xCDcono de google"/><span>Contin\xFAa con Google</span></button>
        ...
        <form id=formRegister>
          ...
          <p id="errorEmail" class=input-error>*Ingresa un email v\xE1lido.</p>
          <label for="inputPassword">CREAR CONTRASE\xD1A</label>
          <div class="gradient">
            <span class="icon-eye">
          ...
          <p id="errorPassword" class=input-error>*Contrase\xF1a [5-10] caracteres. </p>
          <button class="btnRegister">Registrarse</button>
        </form>
        <p class="go-login">\xBFYa tienes una cuenta? <a href="/login">Inicia Sesi\xF3n</a></p>
      </div>
    </div>
    `;
  ...
  btnRegister.addEventListener("click", (event) => {
    ...
    buttonRegister(passwordValue, emailValue).then((user) => {
      ...
      if (error === "auth/email-already-in-use") {
        errorEmail.style.visibility = "visible";
        errorEmail.textContent = "El email ya est\xE1 en uso";
        setTimeout(() => {
          errorEmail.style.visibility = "hidden";
        }, 5e3);
      } else if (error === "auth/internal-error") {
        errorPassword.style.visibility = "visible";
        errorPassword.textContent = "Ingresa una contrase\xF1a";
        setTimeout(() => {
          errorPassword.style.visibility = "hidden";
          errorEmail.style.visibility = "hidden";
        }, 5e3);
        ...
        errorPassword.style.visibility = "visible";
        errorPassword.textContent = "Contrase\xF1a m\xEDnimo 6 caracteres";
        setTimeout(() => {
          errorEmail.style.visibility = "hidden";
          errorPassword.style.visibility = "hidden";
        }, 5e3);
        ...
        errorEmail.style.visibility = "visible";
        errorEmail.textContent = "Email inv\xE1lido";
        setTimeout(() => {
          errorEmail.style.visibility = "hidden";
          errorPassword.style.visibility = "hidden";
        }, 5e3);
  ...
  buttonLoginG(btnGoogle, navigateTo2);
  return mainRegister;
};
const buttonLogin = (passwordValue, emailValue) => new Promise((resolve, reject) => {
...
const google = "data:image/png;base64,";
const Login = (navigateTo2) => {
  const viewLogin = `
    <h1 id="tittleLogo-2">Frikis del Espacio</h1>
    <img id="logo-2" src="${logo}" alt="Imagen del logo"/>  
      <div class="login-view">
        ...
        <div class="container-login">
          ...
          <form action="" id="form-login">
            ...
            <p id= "errorEmail" class=input-error>*Ingresa un email v\xE1lido.</p>
            <label for="password">CONTRASE\xD1A</label>
            ...
            <p id= "errorPassword" class=input-error>*Contrase\xF1a [5-10] caracteres. </p>
            <button id="button-login" type="submit">Iniciar Sesi\xF3n</button>
            <div id="links">
              <p id="create-account">\xBFNo tienes una cuenta? <a href="/register">Crea una</a></span></p>
            </div>
          </form>
        </div>
      </div>
  ...
  buttonLog.addEventListener("click", (event) => {
    ...
    buttonLogin(passwordValue, emailValue).then((user) => {
      console.log(user.nameUser);
      if (user.nameUser) {
        navigateTo2("/dashboard");
      }
      ...
      if (error === "auth/invalid-email" && emailValue !== "") {
        ...
        errorPassword.style.visibility = "visible";
        errorPassword.textContent = "Contrase\xF1a Incorrecta";
        setTimeout(() => {
          errorPassword.style.visibility = "hidden";
          errorEmail.style.visibility = "hidden";
        }, 5e3);
...
const buttonSignOut = (button, navigateTo2) => {
  button.addEventListener("click", async () => {
    signOut(auth).then(() => {
      navigateTo2("/");
    }).catch(() => {
...
const savePostFire = async (textArea) => {
...
const vaca2 = "/assets/vaca2.c1f32303.png";
const imgAlien = "/assets/imgAlienDashboard.22c40f27.png";
const ovni = "/assets/ovni.ddef5729.gif";
const Dashboard = (navigateTo2) => {
  const viewDashboard = `
    <div id="headerDashboard">
      ...
      <article id= "LogOut">
        ...
        <button id ="button-signOut">Cerrar Sesi\xF3n</button>
      </article>
    </div>
    ...
    <div id = "border-textArea">
      <textarea id="post-text" name="textarea" placeholder="Escribir publicaci\xF3n..."></textarea>
    </div>
    <div id = "msg-post">
      <span id="msg-post-text">Se ha compartido tu publicaci\xF3n</span>
    </div>
    ...
    <div id="myModal" class="modal">
      <div class="modal-content">
        <p>\xBFEst\xE1s seguro(a) de eliminar tu publicaci\xF3n?</p>
        <button id="yes">S\xED</button>
  ...
  btnPost.addEventListener("click", () => {
    if (!editStatus) {
      ...
      editPost(id2, { post: postText.value });
      editStatus = false;
      btnPost.innerHTML = "Publicar";
      postText.value = "";
      msgPosT.style.display = "block";
      msgPosT.innerHTML = "Se ha editado tu publicaci\xF3n";
      setTimeout(() => {
        msgPosT.style.display = "none";
      }, 2e3);
    }
  });
  buttonSignOut(buttonOut, navigateTo2);
